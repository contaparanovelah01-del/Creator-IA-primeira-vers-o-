...
export function Login({ onViewChange }: any) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 text-center mb-8">{t.loginToAccount}</p>
        ...
        <div className="w-full max-w-[400px] bg-zinc-50 dark:bg-[#18181b] border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 md:p-8 shadow-2xl">
          ...
          <form className="space-y-5" onSubmit={handleEmailSignIn}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-emerald-400 hover:bg-emerald-500 text-zinc-950 font-bold rounded-xl px-4 py-4 transition-colors mt-4 disabled:opacity-50"
            >
